...
export function CountryComparison() {
  ...
  }, [stats1, stats2, teamStats1, teamStats2, country1, country2, effectiveSource, teamRanks, teamRanksFromTeam, isTeam]);
  ...
  return (
    <Container size="lg">
      ...
      {country1 && country2 && (stats1 || teamStats1) && (stats2 || teamStats2) && availableSources.length > 0 && (
        <>
          <Tabs
