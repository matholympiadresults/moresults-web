  ...
  return (
    <Container size="lg">
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore consolidated results from international math olympiads including IMO, EGMO, EMO, MEMO, RMM, APMO, BMO, JBMO, PAMO, and Baltic Way. Search contestants, competitions, and country statistics."
        />
      </Helmet>
      <Stack gap="xl">
        <Stack gap="xs">
